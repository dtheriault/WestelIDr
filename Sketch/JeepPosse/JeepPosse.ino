...
//
#define RPTR_MONITOR  6          // Repeater Monitor Active Low (not used)
#define PTT_IN        5          // Front Panel Microphone, Active Low
//
...
#define PTT_OUT       4          // PTT to Repeater, Active Low
#define COS_IN        3          // Carrier Detect Input
//
//
// 
// General Defines
...
#define CW_TIMEOUT    60          // Play CW ID every 1m after COS or PTT go active
#define VOICE_TIMEOUT 1800        // Play Voice ID every 30m when IDLE
//#define COS_TIMEOUT   300         // COS/PTT 3m timeout
#define COS_TIMEOUT   150         // COS/PTT 2m timeout
